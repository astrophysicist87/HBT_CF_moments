...
HBT::HBT(double M_in, double K_T_in, double K_Phi_in, double K_Y_in)
{
	M = M_in;
	K_T = K_T_in;
	K_Phi = K_Phi_in;
...
double HBT::eta_t(double r, double phi)
{
	return (
		eta_f * (r/Rad)
				* ( 1.0
...
double HBT::S_function (double tau, double eta, double r, double phi)
{
